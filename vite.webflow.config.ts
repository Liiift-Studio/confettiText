...
// Produces a single self-contained browser global (window.ConfettiText) with no module loader,
...
export default defineConfig({
	build: {
		...
		lib: {
			...
			formats: ['iife'],
			// Exposes the module's exports (fire, attach, clear) as window.ConfettiText.
			name: 'ConfettiText',
			fileName: () => 'confettitext.webflow.min.js',
		},
		minify: true,
	},
})
